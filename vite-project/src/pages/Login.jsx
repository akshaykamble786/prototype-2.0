...
const LoginForm = () => {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-96 rounded-lg bg-gray-200 p-8 m-8 text-black">
        ...
        <form className="mt-6">
          ...
          <div className="mt-1 text-sm leading-6">
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-700 bg-gray-200 p-3 text-black focus:border-indigo-500"
            />
            <div className="flex justify-end text-xs leading-4 text-black mt-2 mb-4">
          ...
          <button
            type="submit"
            className="w-full bg-custom-darkestblue py-3 text-white font-semibold rounded-md"
          >
            Log in
          </button>
        </form>
