...
//   return (
//     <div className="relative max-w-xs w-full sm:w-96 sm:max-h-[500px] flex sm:flex-col flex-row rounded-xl overflow-hidden shadow-lg bg-gray-200 p-4 mx-auto mb-8">
//       {/* Image Section */}
