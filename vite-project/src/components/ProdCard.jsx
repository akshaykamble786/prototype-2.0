...
// const ProdCard = ({ colorOptions, images }) => {
...
//                 <span className="absolute top-0 left-0 w-28 translate-y-4 -translate-x-6 -rotate-45 bg-custom-darkblue text-center text-xs text-white">Elektra's choice</span>
