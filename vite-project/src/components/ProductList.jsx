...
//       {/* Product Image */}
//       <Link to={`/container/${product.id}`}> {/* Navigate to ProductDetail */}
//         <img
...
const ProductList = ({ product }) => {
  const hasColors = product.colors && Object.keys(product.colors).length > 0; // Check if the product has colors
  ...
  return (
    <div className="relative max-w-xs w-96 max-h-[500px] flex flex-col rounded-xl overflow-hidden shadow-lg bg-gray-200 p-4 mx-auto mb-8">
      ...
      <div className="text-xl font-bold">
        ₹
        {hasColors ? product.price : product.price[product.size[0]]}
        {/* If colors are present, show main price; otherwise, show default size price */}
      </div>
